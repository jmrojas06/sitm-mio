...
public class Main {
    ...
    public static void main(String[] args) {
        String dir = System.getProperty("sitm.data", "/opt/swarch/sitm-mio");
        String archivoCsv = args.length > 0 ? args[0] : dir + "/" + System.getProperty("sitm.datagram", "datagrams4pilot.csv");
